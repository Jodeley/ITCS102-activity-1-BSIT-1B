...
genre = input("What genre do you like? (romance/action/slice of life/horror/sci-fi) ").lower()
duration = input("How long should the manga be? (short/medium/long) ").lower()
...
if genre == "romance": 
     if duration == "short":
       if year == "2000s":
         print(f"I recommend Special A by Maki Minami")
     if duration == "medium":
       if year == "2000s":
         print("I recommend Kimi ni Todoke by Karuho Shiina")
     if duration == "long":
       if year == "2000s":
         print("I recommend Honey Lemon Soda by Mayu Murata")
...
# action
     ...
     if duration == "long":
       if year == "2010s":
         print("I recommend Akame ga Kill by Tetsuya Tashiro")
# Slice of Life
elif genre == "slice of life": 
    if duration == "short":
       if year == "2000s":
         print("I recommend Tori Koro by Hai Ran")
    if duration =="medium":
       if year == "2000s":
...
# Sci-fi
    ...
    if duration == "short":
       if year == "2000s":
         print("I recommend Naruto by Mohiro Kitoh")
    if duration == "medium":
       if year == "2000s":
    ...
    print("Sorry, an error occured. Your input may be wrong or currently unavailable.")